...
- Removed internal data accidentally exposed (It was only used for
  testing).
...
- Adding more tests
- Calculating similarities correctly when non-existent genes are
  provided.
...
- Add test for when large number of pathways are needed
  (pathSims_matrix)
