...
```{r GOSemSim, eval=FALSE,fig.cap="Comparison of similarities. Functional similarities compared to biological process semantic similarity.",fig.wide=TRUE,include=TRUE}
library("GOSemSim")
