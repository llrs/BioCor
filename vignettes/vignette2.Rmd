...
abstract: >
  Describes how to use the BioCor package to select the threshold for genes 
...
curves(ecdf(mgeneSim(names(genesReact2), genesReact2)), color = "red")
```
