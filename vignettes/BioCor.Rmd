...
```
The similarity between those two clusters is lower than the one calculated with GOSemSim, maybe due to not having data for some genes in the list provided from `r Biocpkg("reactome.db")`. This serves us a reminder of how important is the input data for the results.
