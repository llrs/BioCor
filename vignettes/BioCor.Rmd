...
In this section I will compare the functional similarity of BioCor with the closely related package `r Biocpkg("GOSemSim")`. The genes to measure are extracted from the vignette of GOSemSim.
...
mclusterSim(clusters, genesReact, "BMA")
```

GOSemSim doesn't compare the clusters by comparing each gene but by comparing the gene ontologies. Thus the most appropiate way to compare the similarities based on gene ontologies and this comparisons
